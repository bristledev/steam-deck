...
Press the **... Button** (bottom-right) on your Deck to bring up the **Overlay**. The battery icon is where all the performance magic happens.
...
- **45 FPS / 90Hz**: The 'Golden Ratio' for the Steam Deck OLED. Smooth motion with decent battery.
